<div align="center">
  ...
  <h1 align="center">wnfs-common</h1>

  <p>
    <a href="https://crates.io/crates/wnfs-common">
      <img src="https://img.shields.io/crates/v/wnfs-common?label=crates" alt="Docs">
    </a>
...
# TODO
- [ ] Figure ownership semantics at ffi boundary
- [ ] Figure out how to handle Rust `Result`s and `Option`s
- [ ] Figure how to use Rust `Future`s from C
- [ ] Figure how to use async code from C. `Blockstore` trait is async.
- [ ] Add build scipts to generate C header files
- [ ] Add C tests
- [ ] Add C examples
